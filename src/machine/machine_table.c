...
const machine_t machines[] = {
    ...
    /* Has a National Semiconductor PC87307 SuperI/O with builtin AMI KBC. */
    {
        .name              = "[i430TX] HP Pavilion 8140 (ASUS TX97-XV)",
        ...
        .fdc_device               = NULL,
        .sio_device               = NULL,
        .vid_device               = NULL, /* Onboard ATi Mach64VT3 video */
        .snd_device               = NULL,
        .net_device               = NULL
    },
